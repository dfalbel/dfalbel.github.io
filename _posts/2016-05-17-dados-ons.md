...
Iniciei um projeto ([Github](https://github.com/dfalbel/ons)) que visa disponibilizar de maneira mais acessível os dados do sistema elétrico que podem ser encontrados no [site do ONS (Operador Nacional do Sistema Elétrico)](http://www.ons.org.br/home/). A idéia de criar este repositório surgiu um bom tempo depois de responder [esta](http://pt.stackoverflow.com/a/103838/6036) pergunta no [Stack Overflow PT](http://pt.stackoverflow.com/).
